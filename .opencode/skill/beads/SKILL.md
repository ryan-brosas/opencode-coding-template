...
For parallel execution with multiple subagents, use the swarm coordination skill (`swarm-coordination`) and related commands (`compound`, `lfg`).
...
- `swarm-coordination` skill for agent orchestration
